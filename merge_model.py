...
parser = argparse.ArgumentParser(description='Script to merge Llama2-7b-chat and LoRA weights')
parser.add_argument('--base_model', default=None, required=True,
                    type=str, help="Base model path (basically Llama2-7b-chat)")
parser.add_argument('--lora_model', default=None, required=True,
                    type=str, help="LoRA model path")
                ...
                if lora_key_A in t_and_l['state_dict']:
                    ...
                    state_dict[k] += (
                            transpose(
                                ...
                                @ t_and_l['state_dict'][lora_key_A].float(), t_and_l['fan_in_fan_out']) * t_and_l[
                                'scaling']
                    )
